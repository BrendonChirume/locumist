...
export default function SignUp() {
    return (
      <>
          <h1 className="text-3xl font-semibold mb-6 text-black">Join our community</h1>
          <h3 className="text-gray-500">Sign up to join our community and start building your brand.</h3>
          <form action="#" method="POST" className="space-y-6 my-6">
              <div>
                  <label htmlFor="firstName"
                         className="block text-base/6 ms-1 text-gray-700">Name</label>
                  <Input type="text" id="firstName" name="firstName"
                         placeholder="Enter name"/>
              </div>
              <div>
                  <label htmlFor="email" className="block text-base/6 ms-1 text-gray-700">Email</label>
                  <Input type="text" id="email" name="email"
                         placeholder="Enter email"/>
              </div>
              <div>
                  <label htmlFor="password"
                         className="block text-base/6 ms-1 text-gray-700">Password</label>
                  <Input type="password" id="password" name="password"
                         placeholder="Enter password"/>
              </div>
              <div>
                  <label htmlFor="confirm-password"
                         className="block text-base/6 ms-1 text-gray-700">Confirm password</label>
                  <Input type="password" id="confirm-password" name="-confirm-password"
                         placeholder="Confirm password"/>
              </div>
              <div className="text-center">
                  <Button variant="flat" className="w-4/5">Sign Up <IconArrowRight className="text-gray-300"
                                                                                   size={16}/> </Button>
              </div>
          </form>
